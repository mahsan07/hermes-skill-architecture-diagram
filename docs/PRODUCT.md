...
Architecture Diagram is a focused, shareable agent workflow.

## What it does

Create dark, readable SVG architecture diagrams from system descriptions. Use when a user asks for this workflow or a closely related task.
